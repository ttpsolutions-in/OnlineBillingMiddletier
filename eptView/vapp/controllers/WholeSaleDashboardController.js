ETradersApp.controller("WholeSaleDashboardController", ['GlobalVariableService', 'PrintService', '$scope', '$filter', '$http', '$location', '$routeParams', '$timeout', 'toaster', 'CommonService',
    'uiGridConstants', 'LoginService', function (GlobalVariableService, PrintService, $scope, $filter, $http, $location, $routeParams, $timeout, toaster, CommonService, uiGridConstants, LoginService) {
